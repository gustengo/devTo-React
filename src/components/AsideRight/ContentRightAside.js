        ...
        <aside>
            <Card style={{ width: '16rem', marginTop: '1.3rem' }}>
                <Card.Body>
                    ...
                    <Card.Text> x DEV Hackathon Submission Post Placeholder Title</Card.Text>
                    ...
                    <Button style={{width: '100%'}} variant="primary">Submit your project!</Button>{' '}
                    <Button style={{width: '100%'}} variant="secondary">See all your posts</Button>
                </Card.Body>
            </Card>
        </aside>
    )
